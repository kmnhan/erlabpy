...
- [Fit a reference when one energy range does not suit every EDC](https://erlabpy.readthedocs.io/en/stable/how-to/python/fermi-edge-correction.html#how-to-python-fit-fermi-edge-separate-ranges)
...
- [Fermi edge correction in ImageTool Manager](https://erlabpy.readthedocs.io/en/stable/how-to/gui/fermi-edge-correction.html)

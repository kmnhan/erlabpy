...
COMPAT_TARGETS: tuple[str, ...] = (
    ...
    "tests/interactive/test_kspace.py::test_movable_circle_roi_extends_upstream_menu",
    "tests/interactive/test_kspace.py::test_movable_circle_roi_deferred_remove_ignores_deleted_roi",
    "tests/interactive/test_utils.py::test_better_axis_item_paint_ignores_deleted_axis",
    "tests/interactive/test_utils.py::test_better_axis_item_paint_ignores_deleted_wrapper_error",
    "tests/interactive/test_utils.py::test_better_axis_item_paint_reraises_unexpected_error",
    "tests/interactive/test_utils.py::test_better_axis_item_preserves_unitless_si_prefix_behavior",
    "tests/interactive/test_utils.py::test_better_axis_item_preserves_tick_and_empty_label_behavior",
    "tests/interactive/test_utils.py::test_better_axis_item_forwards_current_axis_label_options",
    ...
    "tests/interactive/imagetool/manager/workspace/test_format.py::test_qt_window_state_helpers_parse_invalid_and_restore_size",
    "tests/interactive/imagetool/manager/workspace/test_format.py::test_qt_window_state_uses_only_fallback_size_when_native_restore_fails",
    "tests/interactive/imagetool/manager/workspace/test_format.py::test_qt_window_state_restores_maximized_normal_geometry",
    "tests/interactive/imagetool/manager/workspace/test_document.py::test_imagetool_dataset_uses_window_state_and_restores_legacy_size",
    "tests/interactive/imagetool/manager/workspace/test_document.py::test_toolwindow_dataset_uses_window_state_and_restores_legacy_size",
    "tests/interactive/imagetool/manager/workspace/test_loading.py::test_manager_workspace_roundtrip_restores_loader_and_standalone_apps",
    ...
    "tests/interactive/imagetool/manager/test_extensions.py::test_loader_shares_routine_queue_and_rechecks_enablement",
    "tests/interactive/imagetool/manager/test_extensions.py::test_finished_routine_is_not_inserted_while_manager_closes",
    "tests/interactive/imagetool/manager/test_mainwindow.py::test_removed_managed_windows_stay_rooted_until_qt_destroys_them",
    "tests/interactive/imagetool/manager/test_mainwindow.py::test_rejected_managed_tool_close_preserves_registration",
    "tests/interactive/imagetool/manager/test_mainwindow.py::test_remove_all_tools_rechecks_graph_after_reentrant_addition",
    "tests/interactive/imagetool/manager/test_app.py::test_manager_close_event_waits_for_busy_managed_tool",
    "tests/interactive/imagetool/manager/test_app.py::test_manager_close_ignores_reentrant_close_request",
    "tests/interactive/imagetool/manager/test_app.py::test_manager_close_blocks_reentrant_additional_window",
...
COVERAGE_GROUPS: dict[str, tuple[str, ...]] = {
    ...
    "cov-qt-manager-mainwindow": (
        ...
        "tests/interactive/imagetool/manager/test_tutorial_controller.py",
        "tests/interactive/imagetool/manager/test_tutorial_framework.py",

...
class _WorkspaceLoader:
    ...
    def _workspace_tool_restore_references(
        ...
        *,
        ...
        apply_reference = tool_cls._apply_saved_tool_data_reference
        ...
        def _tool_data_reference_resolver(
            ...
            try:
                ...
                try:
                    ...
                    if resolved is None:
                        return None
                    return apply_reference(payload, resolved)
                if (
                    ...
                    if saved_data is not None:
                        return apply_reference(payload, saved_data)
                resolved = _source_data_for_target(

...
AXES_METHODS: dict[str, MethodSpec] = {
    ...
    "minorticks_on": MethodSpec(
        family=FigureMethodFamily.AXES,
        name="minorticks_on",
        label="Show minor ticks",
        tooltip="Runs ax.minorticks_on on every selected axis.",
        target_domain=MethodTargetDomain.AXES,
        call_policy=MethodCallPolicy.BOUND_EACH_AXIS,
        allow_extra_kwargs=False,
    ),
    "minorticks_off": MethodSpec(
        family=FigureMethodFamily.AXES,
        name="minorticks_off",
        label="Hide minor ticks",
        tooltip="Runs ax.minorticks_off on every selected axis.",
        target_domain=MethodTargetDomain.AXES,
        call_policy=MethodCallPolicy.BOUND_EACH_AXIS,
        allow_extra_kwargs=False,
    ),
...
ERLAB_METHODS: dict[str, MethodSpec] = {
    ...
    "plot_core_levels": MethodSpec(
        family=FigureMethodFamily.ERLAB,
        name="plot_core_levels",
        label="plot_core_levels",
        ...
        controls=(
            _literal_arg(
                "Elements",
                0,
                "figureComposerERLabCoreLevelsElementsEdit",
                (
            ...
            _kwarg_combo(
                ...
                ("binding", "kinetic"),
                None,
                "figureComposerERLabCoreLevelsEnergyCombo",
                "Energy scale. Leave unset to infer it from the selected axis.",
                none_label="Infer from axis",
            ),
            _float_pair_kwarg(
                "Limits",
                "limits",
                "figureComposerERLabCoreLevelsLimitsEdit",
                "Inclusive energy limits. Leave blank to use the selected axis limits.",
            ),
            _kwarg_combo(
                "Binding sign",
                "binding_energy_sign",
                ("negative", "positive"),
                None,
                "figureComposerERLabCoreLevelsBindingSignCombo",
                "Binding-energy sign. Leave unset to infer it from the selected axis.",
                none_label="Infer from axis",
            ),
            _float_kwarg(
                "Photon energy",
                "hv",
                "figureComposerERLabCoreLevelsPhotonEnergyEdit",
                "Photon energy in eV. Kinetic energy requires this value.",
                minimum=0.0,
            ),
            _float_kwarg(
                "Work function",
                "work_function",
                "figureComposerERLabCoreLevelsWorkFunctionEdit",
            ...
            _kwarg_combo(
                ...
                _LINE_ORIENTATION_OPTIONS,
                "v",
                "figureComposerERLabCoreLevelsOrientationCombo",
                "Draw horizontal or vertical core-level lines.",
            ),
            _bool_kwarg_combo(
                "Legend labels",
                "legend_labels",
                "figureComposerERLabCoreLevelsLegendLabelsCombo",
                "Add element and orbital labels for a later legend step.",
                default=False,
            ),
            _bool_kwarg_combo(
                "Text labels",
                "text_labels",
                "figureComposerERLabCoreLevelsTextLabelsCombo",
                "Add element and orbital labels next to the lines.",
                default=True,
            ),
            _color_kwarg(
                "Color",
                "colors",
                "figureComposerERLabCoreLevelsColorEdit",
                "Optional Matplotlib color applied to all core-level lines.",
            ),
            _literal_kwarg(
                "Text options",
                "text_kw",
                "figureComposerERLabCoreLevelsTextKwEdit",
                "Optional dictionary passed to the text labels.",
            ),
            _kwarg_combo(
                "Line style",
                "linestyle",

...
def test_format_html_table_basic():
...
def test_format_html_table_no_headers():
...
def test_format_html_table_header_cols():
    rows = [["Header1", "Header2"], ["Row1Col1", "Row1Col2"], ["Row2Col1", "Row2Col2"]]
    expected = (
        "<div><style>\n.erlab-table td,\n.erlab-table th {\n    text-align: left;\n}\n\n"  # noqa: E501
        '.erlab-table th {\n    font-weight: bold;\n}\n</style><table class="erlab-table">'  # noqa: E501
...
def test_format_html_table_no_thead():
    rows = [["Header1", "Header2"], ["Row1Col1", "Row1Col2"], ["Row2Col1", "Row2Col2"]]
    expected = (
        "<div><style>\n.erlab-table td,\n.erlab-table th {\n    text-align: left;\n}\n\n"  # noqa: E501
        '.erlab-table th {\n    font-weight: bold;\n}\n</style><table class="erlab-table">'  # noqa: E501
...
def test_format_value_numpy_array_monotonic():
    val = np.array([1.0, 2.0, 2.1])
    expected = "1→2.1 (3)"
    assert format_value(val) == expected


def test_format_value_numpy_array_non_monotonic():
...
def test_format_value_integer_float():
    val = 42.0
    expected = "42"
    assert format_value(val) == expected

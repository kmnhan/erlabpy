...
class masktool(AnalysisWindow):
    ...
    def __init__(self, data, *args, **kwargs):
        ...
        self.cursor = self.addParameterGroup(
            **{
                "Z dim" : dict(qwtype="combobox", items=self.data.dims, currentText=self.data.dims[-1]),
                "slider" : dict(qwtype="slider", orientation=QtCore.Qt.Horizontal, showlabel=False, value=0, minimum=0, maximum=self.data.shape[-1]-1),
        ...
        self.roi = pg.PolyLineROI([[0,0]],parent=self.images[0], maxBounds=self.axes[0].getViewBox().itemBoundingRect(self.images[0]))
...
if __name__ == "__main__":
    ...
    ds = erlab.io.load_igor_h5("/Users/khan/Documents/ERLab/CsV3Sb5/220630_ALS_Kagome_nesting/maps.h5")
